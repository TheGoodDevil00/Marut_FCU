...
const osThreadAttr_t ArmDisarm_attributes = {
  .name = "ArmDisarm",
  .cb_mem = &ArmDisaermTaskControlBlock,
  .cb_size = sizeof(ArmDisaermTaskControlBlock),
...
const osThreadAttr_t ModeHandler_attributes = {
  .name = "ModeHandler",
  .cb_mem = &Mode_HandlerControlBlock,
  .cb_size = sizeof(Mode_HandlerControlBlock),
  .stack_mem = &ModeHandler_Buffer[0],
  .stack_size = sizeof(ModeHandler_Buffer),
  .priority = (osPriority_t) osPriorityNormal,
};
...
const osThreadAttr_t QuadTask_attributes = {
  .name = "QuadTask",
  .cb_mem = &quad_taskControlBlock,
  .cb_size = sizeof(quad_taskControlBlock),
  .stack_mem = &quad_taskBuffer[0],
  .stack_size = sizeof(quad_taskBuffer),
...
const osMutexAttr_t i2c_mtex_attributes = {
  .name = "i2c_mtex"
};
